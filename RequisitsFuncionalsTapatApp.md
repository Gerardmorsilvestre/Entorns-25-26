...
- Una taula amb qui ha fet servir el pedaç depenen de l'hora. Aplicació Multiusuari.
- Desenvolupar una App simple/sencilla.

## Actors de l'App
- Administrador.
- Serveis medics (metges, oftalmòlegs,...).
- Tutors (mares/pares).
